...
const Footer = () => {
    return (
        <div>
            <footer class="relative bg-blue-950 pt-8 pb-6 text-white">
                    ...
                    <div class="flex flex-wrap text-left ">
                        <div class="w-full lg:w-6/12 px-4">
                            ...
                            <div class="mt-6 lg:mb-0 mb-6">
                                <button class="cursor-pointer hover:text-blue-200 text-4xl shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                <FaFacebook /></button>
                                <button class="cursor-pointer hover:text-blue-200 text-4xl shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                <FaTwitter /></button>
                                <button class="cursor-pointer hover:text-blue-200 text-4xl shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                <FaSquareInstagram /></button>
                                <button class="cursor-pointer hover:text-blue-200 text-4xl shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
                                <FaLinkedin /></button>
